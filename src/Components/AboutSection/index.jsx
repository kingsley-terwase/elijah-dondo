            ...
            <Container maxWidth="lg">
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        ...
                        >
                            ...
                            <Typography variant="body1" sx={{ fontFamily:FONT_FAMILY.secondary, mb: 3, lineHeight: 2, fontSize: '1.05rem' }}>
                                With over 5 years of experience in full-stack development, I've helped
                ...
                <Grid container spacing={3} sx={{py:8}}>
                            {[
                                ...
                                { number: '5+', label: 'Years Experience', color: '#00d4ff' },
                                { number: '5+', label: 'Years Experience', color: '#ff006e' },
                            ].map((stat, i) => (
